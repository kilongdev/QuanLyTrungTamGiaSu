      ...
      <div className="flex items-center justify-between h-30 px-10 text-md bg-white">
        ...
        <nav className="hidden lg:flex gap-5">
          ...
          <NavItem
            ...
            hasDropdown
            dropdownItems={[
              { label: "Dịch vụ gia sư", to: "/dich-vu-gia-su" },
              { label: "Học phí gia sư", to: "/hoc-phi-gia-su" },
            ]}
          >
            Phụ huynh
          </NavItem>
          <NavItem to="/hoc-phi-gia-su">Học phí gia sư</NavItem>

          <NavItem to="/lop-hien-co">Lớp học hiện có</NavItem>
