...
export default function LopHocManagement() {
  ...
  const handleSaveAttendanceForToday = async () => {
    ...
    const danh_sach = Object.entries(attendanceForToday).map(
      ([hoc_sinh_id, tinh_trang]) => ({
  ...
  const handleEdit = (lopHoc) => {
    ...
    setFormData({
      ...
      ngay_ket_thuc: lopHoc.ngay_ket_thuc
        ? lopHoc.ngay_ket_thuc.split(" ")[0]
        : "",
    });
  ...
  const generateAutoClassName = (sourceData, excludedId = null) => {
    const monHoc = monHocs.find(
      (m) => String(m.mon_hoc_id) === String(sourceData.mon_hoc_id),
    );
  ...
  const subjectSections = Object.entries(groupedBySubject).sort(
    ([subjectA], [subjectB]) => subjectA.localeCompare(subjectB, "vi"),
  );
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 p-5 border-b border-gray-200">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">
              Tổng số: {lopHocs.length} lớp học
            </p>
          </div>
          <button
                ...
                <section key={subjectName} className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          {classes.length} lớp trong môn này
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                    {classes.map((lopHoc, idx) => (
                      <div
                        key={`${subjectName}-${lopHoc.lop_hoc_id}-${idx}`}
                        className="rounded-xl border border-gray-200 bg-white hover:shadow-md transition-shadow relative overflow-visible"
                      >
                        ...
                        <div className="p-4 space-y-3">
                          <div className="pr-8">
                            <h4 className="font-semibold text-gray-900 text-base line-clamp-2">
                              {lopHoc.ten_lop ||
                                `Lớp ${lopHoc.khoi_lop || "N/A"} - ${subjectName}`}
                            </h4>
                            <p className="text-sm text-gray-500 mt-0.5">
                              Khối lớp: {lopHoc.khoi_lop || "Chưa cập nhật"}
                            </p>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            <div className="bg-gray-50 rounded-lg px-3 py-2">
                              ...
                              <p className="text-gray-800 font-medium truncate">
                                {getGiaSuName(lopHoc.gia_su_id)}
                              </p>
                            </div>
                            <div className="bg-gray-50 rounded-lg px-3 py-2">
                              <p className="text-gray-500 text-xs">Số buổi</p>
                              <p className="text-gray-800 font-medium">
                                {lopHoc.so_buoi_hoc || 0} buổi
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="space-y-1 text-sm">
                            ...
                            <p className="text-gray-600">
                              Tối đa {lopHoc.so_luong_toi_da || 1} học sinh
                            </p>
                          </div>

                          <div className="pt-2 border-t border-gray-100 flex justify-between items-center">
                            <span className="text-xs text-gray-400">
                              ID: {lopHoc.lop_hoc_id}
                            </span>
                            <span
                              className={`inline-block px-2.5 py-1 text-xs font-medium rounded-full ${getTrangThaiColor(lopHoc.trang_thai)}`}
                            >
                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-3">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, mon_hoc_id: e.target.value })
                      }
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, khoi_lop: e.target.value })
                        }
                        className="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, gia_su_id: e.target.value })
                      }
                      className="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            so_luong_toi_da: e.target.value,
                          })
                        }
                        className="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="1"
                  ...
                  {formData.gia_toan_khoa && formData.so_buoi_hoc && (
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                      <p className="text-sm text-gray-600 font-medium">
                        Giá mỗi buổi (tính tự động):
                      </p>
                      <p className="text-xl font-bold text-blue-600">
                        {formatPrice(
                          calculatePricePerSession(
                            formData.gia_toan_khoa,
                            formData.so_buoi_hoc,
                            formData.loai_chi_tra,
                            formData.gia_tri_chi_tra,
                          ),
                        )}
                        đ
                      </p>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              gia_tri_chi_tra: e.target.value,
                            })
                          }
                          className="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder={
                          ...
                          min="0"
                          step={
                            formData.loai_chi_tra === "phan_tram" ? "1" : "1000"
                          }
                          max={
                            formData.loai_chi_tra === "phan_tram"
                              ? "100"
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <label className="inline-flex items-center gap-2 text-sm text-gray-700">
                          <input
                            ...
                            onChange={(e) =>
                              setCreateWithSchedule(e.target.checked)
                            }
                          />
                          Tạo lịch học ngay
                        </label>
                            ...
                            <div className="grid grid-cols-3 gap-2">
                              {WEEKDAY_OPTIONS.map((day) => (
                                ...
                                >
                                  <input
                                    type="checkbox"
                                    checked={scheduleForm.ngay_trong_tuan.includes(
                                      day.value,
                                    )}
                                    onChange={(e) => {
                                      ...
                                      setScheduleForm((prev) => ({
                                        ...
                                        ngay_trong_tuan: checked
                                          ? [
                                              ...prev.ngay_trong_tuan,
                                              day.value,
                                            ].sort((a, b) => a - b)
                                          : prev.ngay_trong_tuan.filter(
                                              (v) => v !== day.value,
                                            ),
                                      }));
                                    }}
                      ...
                      classStudents
                        ...
                        .map((student, idx) => (
                          ...
                          >
                            ...
                            <button
                              onClick={() =>
                                removeStudentFromClass(editingId, student.id)
                              }
                  ...
                  {allHocSinh && allHocSinh.length > 0 ? (
                    allHocSinh
                      .filter((student) => {
                        if (
                          classStudents &&
                          classStudents.find((s) => s && s.id === student.id)
                        ) {
                          return false;
                        }
                        ...
                        {classStudents.map((student) => (
                          ...
                          >
                            ...
                            <div className="flex gap-2">
                              <button
                                onClick={() =>
                                  updateAttendanceStatus(student.id, "co_mat")
                                }
                              ...
                              <button
                                onClick={() =>
                                  updateAttendanceStatus(student.id, "vang")
                                }
                                className={`flex-1 px-2 py-1.5 text-xs font-medium rounded transition ${
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            <p className="font-semibold text-gray-800">
                              Buổi học ngày {scheduleData.ngay_hoc}
                            </p>
                            <span className="text-xs text-gray-500">
                              {scheduleData.gio_bat_dau
                                ? `${scheduleData.gio_bat_dau} - ${scheduleData.gio_ket_thuc}`
                                : "N/A"}
                            </span>
                          </div>
                              ...
                              >
                                ...
                                <span
                                  className={`px-2 py-1 rounded text-xs font-medium ${
                                    student.tinh_trang === "co_mat"
                                      ? "bg-green-100 text-green-700"
                                      : student.tinh_trang === "vang"
