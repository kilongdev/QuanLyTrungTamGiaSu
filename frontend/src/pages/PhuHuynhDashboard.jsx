    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 border-2 border-dashed border-gray-200 flex items-center justify-center min-h-[200px]">
          <button className=" flex gap-1 text-center text-gray-400 hover:text-blue-500 transition-colors">
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-end">
        <button className=" flex gap-1 px-4 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors font-medium">
          <Plus />
          Thêm con
        </button>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4 items-end">
          ...
          <div>
            <button className="w-full px-6 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors font-medium">
              Tìm kiếm
            </button>
          </div>
        </div>
